...
window.PPM_MOTIVATION = {
  ...
  partB: {
    instruction: "Выберите 3 способности, которыми хотели бы заняться в первую очередь. Для каждой отметьте, что вами движет (можно несколько): интересно само по себе; важно для меня как педагога; этого требует кафедра/руководство; нужно для карьеры/аттестации.",
    pick: 3,
    motives: [
      { id: "m1", text: "интересно само по себе",             type: "autonomous" },
      { id: "m2", text: "важно для меня как педагога",         type: "autonomous" },
